        ...
        <div className="relative flex flex-col items-center justify-center min-h-screen p-10 bg-gray-50">
            ...
            <div className="">
                ...
                >
                    ...
                    />
                    <p className="text-black font-bold text-lg text-center">Upload File</p>
                    <p className="text-gray-400 text-sm text-center">Click to select files</p>
                    ...
                    {images.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center w-full h-full">
                            ...
                            <p className="text-gray-400 text-sm text-center">No files selected</p>
                        </div>
                    )}
                </motion.label>
                <motion.button
