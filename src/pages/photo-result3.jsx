...
const CardImages = () => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.NEXT_PUBLIC_API_URL_NGROK_AUFA}get_matched_images`, {
        headers: {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 overflow-y-auto h-screen">
          {photos.map((photo, index) => (
            ...
            >
              ...
              />
              <img
                src={`${process.env.NEXT_PUBLIC_API_URL_NGROK_AUFA}matched_image/${photo}`}
                alt={`${process.env.NEXT_PUBLIC_API_URL_NGROK_AUFA}matched_image/${photo}`}
              />
              {/* <Watermark imageUrl={`${process.env.NEXT_PUBLIC_API_URL_NGROK_AUFA}matched_image/${photo}`} /> */}
