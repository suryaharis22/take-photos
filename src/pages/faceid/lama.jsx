      ...
      {loading ? (
        ...
        <div className="relative w-full max-w-md">
          {!faceInFrame && (
            <p
              style={{ zIndex: 7 }}
              className="text-sm font-semibold text-red-500 absolute top-0 left-50 right-50"
            >
              Posisi kan Wajah ditengah kotak
            </p>
          )}
          {!distanceValid && (
            <p
              style={{ zIndex: 7 }}
              className="text-sm font-semibold text-red-500 absolute top-4 left-50 right-50"
            >
              Jarak antar Kamer terlalu jauh/dekat
            </p>
          )}
          {!angleValid && (
            <p
              style={{ zIndex: 7 }}
              className="text-sm font-semibold text-red-500 absolute top-8 left-50 right-50"
            >
              Sudut wajah: Tidak sejajar
            </p>
          )}
